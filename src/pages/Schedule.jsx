      ...
      <div className="activityContainer">
        {actvities.map((activity) => (
          <div key={activity._id} className="activityBox">
            ...
            <p className="activityDes"><i>{activity.activityDescription}</i></p>
          </div>
        ))}
      </div>
      <div className="activityDetailBtn">
      <a href="https://drive.google.com/file/d/1P3QoaV49qpMRUgTPtArJhVCecDHRps4Q/view?usp=sharing" className="midBtn DetBtn">View Acitivities in Detail</a>
      </div>
      </div>
    </main>
  )
